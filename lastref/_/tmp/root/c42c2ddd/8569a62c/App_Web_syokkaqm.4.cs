...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_syokkaqm {
        ...
        private FastObjectFactory_app_web_syokkaqm() {
        }
        
        static object Create_ASP_admin__kapakyap_aspx() {
            return new ASP.admin__kapakyap_aspx();
        }
        
        static object Create_ASP_admin_maillist_aspx() {
            return new ASP.admin_maillist_aspx();
        }
    }
}
