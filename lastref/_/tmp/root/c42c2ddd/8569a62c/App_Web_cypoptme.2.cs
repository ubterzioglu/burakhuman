...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_cypoptme {
        ...
        private FastObjectFactory_app_web_cypoptme() {
        }
        
        static object Create_ASP_product1_aspx() {
            return new ASP.product1_aspx();
        }
    }
}
