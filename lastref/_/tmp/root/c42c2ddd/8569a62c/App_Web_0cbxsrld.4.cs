...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_0cbxsrld {
        ...
        private FastObjectFactory_app_web_0cbxsrld() {
        }
        
        static object Create_ASP_signup_aspx() {
            return new ASP.signup_aspx();
        }
        
        static object Create_ASP_books_aspx() {
            return new ASP.books_aspx();
        }
    }
}
