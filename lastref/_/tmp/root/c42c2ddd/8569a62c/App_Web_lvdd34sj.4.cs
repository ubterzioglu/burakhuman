...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_lvdd34sj {
        ...
        private FastObjectFactory_app_web_lvdd34sj() {
        }
        
        static object Create_ASP_admin_types_aspx() {
            return new ASP.admin_types_aspx();
        }
        
        static object Create_ASP_admin_siparisdetay_aspx() {
            return new ASP.admin_siparisdetay_aspx();
        }
    }
}
