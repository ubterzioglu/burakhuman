...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_432fnagl {
        ...
        private FastObjectFactory_app_web_432fnagl() {
        }
        
        static object Create_ASP_admin_hesap_aspx() {
            return new ASP.admin_hesap_aspx();
        }
    }
}
