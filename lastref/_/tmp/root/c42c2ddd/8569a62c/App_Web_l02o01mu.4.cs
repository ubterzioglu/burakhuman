...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_l02o01mu {
        ...
        private FastObjectFactory_app_web_l02o01mu() {
        }
        
        static object Create_ASP_admin_uyeler_aspx() {
            return new ASP.admin_uyeler_aspx();
        }
        
        static object Create_ASP_admin_mesaj_aspx() {
            return new ASP.admin_mesaj_aspx();
        }
    }
}
