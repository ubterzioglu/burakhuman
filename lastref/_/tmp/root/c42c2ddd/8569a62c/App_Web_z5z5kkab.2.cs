...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_z5z5kkab {
        ...
        private FastObjectFactory_app_web_z5z5kkab() {
        }
        
        static object Create_ASP_admin_hesaplar_aspx() {
            return new ASP.admin_hesaplar_aspx();
        }
    }
}
