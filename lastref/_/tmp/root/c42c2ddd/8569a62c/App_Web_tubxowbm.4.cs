...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_tubxowbm {
        ...
        private FastObjectFactory_app_web_tubxowbm() {
        }
        
        static object Create_ASP_admin_kategori_aspx() {
            return new ASP.admin_kategori_aspx();
        }
        
        static object Create_ASP_admin_mesajlar_aspx() {
            return new ASP.admin_mesajlar_aspx();
        }
    }
}
