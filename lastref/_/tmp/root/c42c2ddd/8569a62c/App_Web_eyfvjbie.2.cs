...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_eyfvjbie {
        ...
        private FastObjectFactory_app_web_eyfvjbie() {
        }
        
        static object Create_ASP_admin_medya_aspx() {
            return new ASP.admin_medya_aspx();
        }
    }
}
