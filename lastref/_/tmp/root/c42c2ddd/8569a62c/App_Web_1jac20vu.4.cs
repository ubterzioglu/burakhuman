...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_1jac20vu {
        ...
        private FastObjectFactory_app_web_1jac20vu() {
        }
        
        static object Create_ASP_admin_file_aspx() {
            return new ASP.admin_file_aspx();
        }
        
        static object Create_ASP_admin_ayar_aspx() {
            return new ASP.admin_ayar_aspx();
        }
    }
}
