...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_j31f0eyh {
        ...
        private FastObjectFactory_app_web_j31f0eyh() {
        }
        
        static object Create_ASP_failed_aspx() {
            return new ASP.failed_aspx();
        }
        
        static object Create_ASP_blogs_aspx() {
            return new ASP.blogs_aspx();
        }
    }
}
