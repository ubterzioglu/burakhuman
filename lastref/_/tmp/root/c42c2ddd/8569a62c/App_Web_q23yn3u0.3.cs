#pragma checksum "C:\Inetpub\vhosts\humanconsciousnessdecoded.com\httpdocs\admin\iceriksirala.aspx.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2A2CD414BA931C80F486B9783272C51FAA1D29E4"

#line 1 "C:\Inetpub\vhosts\humanconsciousnessdecoded.com\httpdocs\admin\iceriksirala.aspx.cs"
using System;
...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    {
        rptIcerikler.DataSource = sf.getdt("pages", command + " Order by rank asc");
    ...
    protected void drpKategoriler_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("iceriksirala?type=" + type + "&cat=" + i + "&lang=" + lang);
    }
