...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_oo4px14x {
        ...
        private FastObjectFactory_app_web_oo4px14x() {
        }
        
        static object Create_ASP_success_aspx() {
            return new ASP.success_aspx();
        }
    }
}
