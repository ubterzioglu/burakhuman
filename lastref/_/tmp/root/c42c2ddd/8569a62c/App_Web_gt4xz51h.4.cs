...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_gt4xz51h {
        ...
        private FastObjectFactory_app_web_gt4xz51h() {
        }
        
        static object Create_ASP_admin_icerik_aspx() {
            return new ASP.admin_icerik_aspx();
        }
        
        static object Create_ASP_admin_files_aspx() {
            return new ASP.admin_files_aspx();
        }
    }
}
