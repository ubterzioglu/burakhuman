...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_e1r4ypgc {
        ...
        private FastObjectFactory_app_web_e1r4ypgc() {
        }
        
        static object Create_ASP_icerik_aspx() {
            return new ASP.icerik_aspx();
        }
    }
}
